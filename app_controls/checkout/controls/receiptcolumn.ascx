<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="receiptcolumn.ascx.cs" Inherits="ED_LearnPad.app_controls.checkout.controls.CheckoutControl_ReceiptColumn" %>
