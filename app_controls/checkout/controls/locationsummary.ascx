<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="locationsummary.ascx.cs" Inherits="ED_LearnPad.app_controls.checkout.controls.CheckoutControls_LocationSummary" %>
<div class="mainPay">
