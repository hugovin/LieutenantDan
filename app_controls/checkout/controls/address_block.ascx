<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="address_block.ascx.cs" Inherits="ED_LearnPad.app_controls.checkout.controls.CheckoutControls_AddressBlock" %>
    ...
    <div class="boxContAddress">
        <div class="mainAddress">
            ...
            <div class="controlMainAddress2">
                <div><asp:LinkButton ID="ChooseButton" runat="server"><img src="<% = GlobalHelper.globalSiteImagesPath %>/buttonShipToAddre.jpg" alt="Ship to this Address" /></asp:LinkButton></div>
                <div class="btnUserAddress1"><asp:LinkButton ID="EditButton" runat="server"><img src="<% = GlobalHelper.globalSiteImagesPath %>/buttonEdit.jpg" alt="Edit" /></asp:LinkButton></div>
                <div class="btnUserAddress2"><asp:LinkButton ID="DeleteButton" OnClick="DeleteButton_Clicked" runat="server"><img src="<% = GlobalHelper.globalSiteImagesPath %>/buttonDelete.jpg" alt="Delete" /></asp:LinkButton></div>
                <div class="clear"></div>
            </div>
        </div>         
    </div>       
