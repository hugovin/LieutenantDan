...
function CopyLocation()
{
    if(SameShipping.checked)
    {
        ...
        */
        ...
        if( BillingFullnameTextbox1.value != '' && 
            ...
            {
                DisplayAddressBookSelection("", BillingBusinessNameTextbox1.value, BillingFullnameTextbox.value, BillingAddressLine1Textbox.value, BillingAddressLine2Textbox.value, BillingCityTextbox.value, BillingStateDropdown.value, BillingPostalCodeTextbox.value, BillingPhoneTextbox.value, true);            
            }
            else
            {
