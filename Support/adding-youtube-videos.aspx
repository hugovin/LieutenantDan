<%@ Page Title="" Language="C#" MasterPageFile="~/Support/Support.Master" AutoEventWireup="true" CodeBehind="adding-youtube-videos.aspx.cs" Inherits="ED_LearnPad.Support.adding_youtube_videos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span3">
                    ...
                    <li class="active"><a href="adding-youtube-videos.aspx" class="navColor"><i class="icon-chevron-right"></i>Adding YouTube videos</a></li>
            ...
            <div class="span9">
                <section id="Gettingstarted">
                    <div class="page-header"><h2>Adding YouTube Videos <small></small></h2></div>
                          <p>
    ...
    <p class="notranslate" style="margin-left:10px;">
        <a href="http://www.youtube.com/watch?v=xGpsVmWLRFA">http://www.youtube.com/<span style="background-color:#FDD;">watch?v=</span>xGpsVmWLRFA</a>
    </p>
    <p style="margin-left:20px;">
        ....becomes....
    </p>
    <p class="notranslate" style="margin-left:10px;">
        <a href="http://www.youtube.com/embed/xGpsVmWLRFA">http://www.youtube.com/<span style="background-color:#DFD;">embed/</span>xGpsVmWLRFA</a>
    </p>
    <p>
        ...then add the modified link as a <a href="adding-web-pages.cfm">web page activity</a>.
    </p>
                </section>
            </div>
        </div>
